...
const I18N = {
  ...
  dl_desktop:      { tr:'Bilgisayar',            en:'Computer',            fa:'کامپیوتر' },
  dl_desktop_sub:  { tr:'Windows · macOS · Linux — tek tıkla kurulur, kendi penceresinde açılır', en:'Windows · macOS · Linux — one click, opens in its own window', fa:'ویندوز · مک · لینوکس — با یک کلیک نصب می‌شود و در پنجرهٔ خودش باز می‌شود' },
  dl_manual_sub:   { tr:'Chrome ya da Edge ile açın; adres çubuğundaki kurulum simgesi veya ⋮ menüsü → “Uygulamayı yükle”.', en:'Open in Chrome or Edge; the install icon in the address bar, or ⋮ menu → “Install app”.', fa:'با کروم یا اج باز کنید؛ آیکن نصب در نوار آدرس یا منوی ⋮ ← «نصب برنامه».' },
  dl_install:      { tr:'Kur',                   en:'Install',             fa:'نصب' },
  dl_installed:    { tr:'Kurulu',                en:'Installed',           fa:'نصب شده' },
  dl_installed_sub:{ tr:'Bu cihaza kurulu — simgeden açabilirsiniz.', en:'Installed on this device — open it from the icon.', fa:'روی این دستگاه نصب است — از آیکن باز کنید.' },
  ...
  dl_note:         { tr:'Hepsi aynı uygulamadır; veriler ortaktır. Android’de kurulum dosyası (.apk) tarayıcı olmadan açılan gerçek bir uygulama verir. Bilgisayarda ayrı dosya gerekmez — tarayıcı uygulamayı masaüstüne kurar.', en:'They are all the same app and share the same data. On Android the .apk gives you a real app that opens without a browser. On a computer no separate file is needed — the browser installs the app to your desktop.', fa:'همه یک برنامه هستند و داده‌ها مشترک است. در اندروید فایل .apk یک برنامهٔ واقعی می‌دهد که بدون مرورگر باز می‌شود. در کامپیوتر فایل جداگانه لازم نیست — مرورگر برنامه را روی دسکتاپ نصب می‌کند.' },
  dl_apk_head:     { tr:'Android’de kurulum', en:'Installing on Android', fa:'نصب در اندروید' },
  dl_apk:          { tr:'Dosyayı indirip açın. Android ilk seferde “bilinmeyen kaynaklardan kuruluma izin ver” diye sorarsa bir kez onaylayın — dosya Play Store’dan gelmediği için normaldir.', en:'Download the file and open it. If Android asks to “allow installing from unknown sources” the first time, approve it once — that is normal for a file that does not come from the Play Store.', fa:'فایل را دانلود و باز کنید. اگر اندروید بار اول «اجازهٔ نصب از منابع ناشناس» خواست، یک بار تأیید کنید — برای فایلی که از Play Store نمی‌آید عادی است.' },
