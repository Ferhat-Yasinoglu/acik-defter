...
const I18N = {
  ...
  dl_soon:         { tr:'Android dosyası henüz yayınlanmadı', en:'Android file not published yet', fa:'فایل اندروید هنوز منتشر نشده' },
  dl_soon_sub:     { tr:'.apk ilk sürüm yayınlandığında burada belirir. O zamana kadar Android’de de tarayıcıdan “Telefona Kur” yolunu kullanın — aynı uygulamadır.', en:'The .apk appears here once the first release is published. Until then use “Install App” from the browser on Android too — it is the same app.', fa:'فایل .apk پس از انتشار نخستین نسخه اینجا ظاهر می‌شود. تا آن زمان در اندروید هم از «نصب روی موبایل» در مرورگر استفاده کنید — همان برنامه است.' },
